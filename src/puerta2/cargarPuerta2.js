function obtenerCitasActuales() {
    fetch("https://ferreous-realinemen.000webhostapp.com/mostrarPuerta.php?puerta=2")
  ...
  function obtenerCitasPasadas() {
    fetch("https://ferreous-realinemen.000webhostapp.com/citasPasadas.php?puerta=2")
      .then((response) => response.json())
      .then((data) => {
        // Procesa los datos recibidos y actualiza las tablas
  ...
  function obtenerCitasFuturas() {
    fetch("https://ferreous-realinemen.000webhostapp.com/citasFuturas.php?puerta=2")
      .then((response) => response.json())
      .then((data) => {
        // Procesa los datos recibidos y actualiza las tablas
